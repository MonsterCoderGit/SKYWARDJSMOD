...
let schedule = {
    ...
    "9:52 AM - 10:39 AM": 3,
    "10:43 AM - 11:30 AM": 4,
    "11:34 AM - 11:59 AM": 5, // Lunch A (Lunch)
    "11:59 AM - 12:46 PM": 5, // Lunch A (Class)
    "11:34 AM - 12:21 PM": 5, // Lunch B (Class)
    "12:21 PM - 12:46 PM": 5, // Lunch B (Lunch)
    "12:50 PM - 1:37 PM": 6,
    "1:41 PM - 2:28 PM": 7,
    "2:32 PM - 3:20 PM": 8, // MTSS
};
...
function genMissingAssignments() {
    ...
    for (let i = 0; i < count; i++) {
        populateMissingAssignmentsTable(missingAssignmentsTable, firstName, count, prompt(`Due Date For Assignment ${i+1}: `), prompt(`Name For Assignment ${i+1}: `), prompt(`Period For Assignment ${i+1}: `), prompt(`Class Name for Assignment${i+1}: `), prompt(`Teacher Name for Assignment ${i+1}: `))
    }
}

//HTML Generator
function populateMissingAssignmentsTable(outerTable, studentName, numMissing, dueDate, assignmentName, period, className, teacherName) {
